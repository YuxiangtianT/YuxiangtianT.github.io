...
```
行内式 [博客](https://yuxiangtiant.github.io "我的个人博客") 链接，带 title。

行内式 [GitHub](https://github.com/YuxiangtianT) 链接。

引用式 [博客][1] 链接。

引用式 [GitHub][2] 链接，带 title。

[1]: https://yuxiangtiant.github.io
[2]: https://github.com/YuxiangtianT "我的 GitHub 主页"
```
...
```html
<p>行内式 <a href="https://yuxiangtiant.github.io" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/YuxiangtianT">GitHub</a> 链接。</p>

<p>引用式 <a href="https://yuxiangtiant.github.io">博客</a> 链接。</p>

<p>引用式 <a href="https://github.com/YuxiangtianT" title="我的 GitHub 主页">GitHub</a> 链接，带 title。</p>
```
